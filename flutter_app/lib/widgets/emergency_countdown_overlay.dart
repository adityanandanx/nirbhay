...
class EmergencyCountdownOverlay extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (safetyState.isEmergencyCountdownActive && safetyState.emergencyCountdownStartTime != null) {
      final elapsedDuration = DateTime.now().difference(safetyState.emergencyCountdownStartTime!);
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () {
                  ref.read(safetyStateProvider.notifier).cancelEmergencyCountdown();
                },
